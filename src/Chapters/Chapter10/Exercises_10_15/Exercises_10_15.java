...
public class Exercises_10_15 {
    public static void main(String[] args) {
        ...
        System.out.println("The bounding rectangle's center (" + rectangle1.getX() + "," +
                rectangle1.getY() + ") , width " + rectangle1.getWeight() + " ,Height " + rectangle1.getHeight());
    }
